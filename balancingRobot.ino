...
void loop()
{
  ...
  angle_pitch += gyro_x * 0.0000611;   //0.0000611 = 1 / (250Hz / 65.5)                               
  angle_roll += gyro_y * 0.0000611;                                   
  
  angle_pitch += angle_roll * sin(gyro_z * 0.000001066);  //0.000001066 = 0.0000611 * (3.142 / 180)             
  angle_roll -= angle_pitch * sin(gyro_z * 0.000001066);               
  
  //Accelerometer angle calculations
  acc_total_vector = sqrt((acc_x*acc_x)+(acc_y*acc_y)+(acc_z*acc_z));  
  angle_pitch_acc = asin((float)acc_y/acc_total_vector)* 57.296;  //57.296 = 1 / (3.142 / 180)     
